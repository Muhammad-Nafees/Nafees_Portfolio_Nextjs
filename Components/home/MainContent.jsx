        ...
        <div className="pt-4 px-4 flex flex-col justify-center items-center">
          ...
          <div className="flex py-4 space-x-4">
            {/* <Link
              ...
              className=" hover:bg-black hover:text-white border text-white border-black w-36 h-12 text-center justify-center items-center flex  m-auto py-2 px-4 rounded-full bg-[#353535]"
            >
              Download Cv
            </Link> */}
            <CustomlinkButton
              ...
              target={"_blank"}
              extraStyle={
                "hover:bg-black hover:text-white border text-white border-black w-36 h-12 text-center justify-center items-center flex  m-auto py-2 px-4 rounded-full bg-[#353535]"
              }
              text={"Download Cv"}
            />
            ...
            <CustomlinkButton
              ...
              extraStyle={
                " hover:bg-black hover:text-white border text-white border-black w-32 h-12 text-center justify-center items-center flex  m-auto py-2 px-4 rounded-full bg-[#353535]"
              }
              text={"Contact info"}
            />
          </div>
